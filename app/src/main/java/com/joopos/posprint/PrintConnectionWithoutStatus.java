...
public class PrintConnectionWithoutStatus extends AsyncTask<Void, Void, Boolean> {
    private String printerIp;
    private int printerPort;
    private String textToPrint;

    public PrintConnectionWithoutStatus(String printerIp, int printerPort, String textToPrint) {
